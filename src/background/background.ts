...
type GlobalStateKey = 'query'; // we might need:  'jobDescription' | 'currentUrl'  | 'jobPostId';
...
function sendToContentScript(message: Message) {
...
function getQuery(jobDescription: string) {
  return `You are a smart assistant to career advisors at the Harvard Extension School. Your take is to rewrite
